...
export default function PersonAlt2(props: Readonly<PersonProps>) {
    ...
    return (
        <Box marginInline={"auto"} padding="space-16" width="100%" maxWidth="1200px">
            ...
            <VStack padding="space-8">
                ...
                {fnr && data &&
                    <ShowAuditLoggAlt2 fnr={fnr} skattekort={data} jumpToBatches={props.handleShowBatchesAt} />}
            </VStack>
        </Box>
    );
}
