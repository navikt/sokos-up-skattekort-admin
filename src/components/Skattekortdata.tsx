...
import {menneskeleseligKilde, type Skattekort, Trekkode,} from "../types/SkattekortResponseDTOSchema";
...
export type SkattekortDataProps = {
            ...
            <VStack gap="space-8">
                <HStack justify="space-between" wrap={false}>
                    ...
                    <Button variant={"tertiary"}
                            onClick={() => jumpToBatches(new Date(skattekort.opprettet))}>
                        {`Mottatt: ${toLocalDate(skattekort.opprettet)} - ${toLocalTime(skattekort.opprettet)}`}</Button>
                </HStack>
